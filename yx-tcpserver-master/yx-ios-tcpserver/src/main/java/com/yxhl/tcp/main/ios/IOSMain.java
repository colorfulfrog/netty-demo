...
public class IOSMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        IOSMain myServer = new IOSMain();

        // 获取spring上下文
        ApplicationContext appContext =
                new ClassPathXmlApplicationContext(new String[]{"classpath:spring-ios.xml"});
        ...
        yxBizServer.setPort(TcpServerConstants.IOS_PORT);
